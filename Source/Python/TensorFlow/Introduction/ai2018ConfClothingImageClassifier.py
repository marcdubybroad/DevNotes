...
# for my oown 28x28 grayscale image
...
index = 27
# 42 index test wrong 6 vs 3, so try more epochs to see if ti gets it right with > accuracy (only 90% accuracy with 5 epochs)
