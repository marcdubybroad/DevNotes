...
create table SAMPLE_19k as select new.ID, new.t2d_19k as t2d, new.SEX, new.origin, new.origin_African_American, new.origin_East_Asian, new.origin_European, new.origin_Hispanic, new.origin_South_Asian,
