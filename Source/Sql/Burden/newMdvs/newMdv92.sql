...
insert into SAMPLES_DATASET (ID, EXP, VER, SG, TECH, ANCESTRY, PARENT, TBL, SORT, CASES, CONTROLS, SUBJECTS, MEANING)
  values('samples_mi_mdv92', 'ExChip_mi', 'mdv92', 'MI', 'ExChip', 'Mixed', 'Root', 'SAMPLE_mi', 90, 10022, 12043, 22065, 'GENE, VARIANT, DATASET_ExSeq_EOMI_mdv92');
...
insert into SAMPLES_PROP_ID (ID, PROP) select 'samples_mi_mdv92', PROP from SAMPLES_PROP_ID where ID = 'samples_mi_mdv90';
